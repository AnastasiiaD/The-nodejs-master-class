                ...
                if (tokenIsValid) {
                    ...
                    _data.read('users', phone, function (err, userData) {
                        if (!err && userData) {
                            ...
                            callback(400, {'Error': 'The specified use does not exist'});
                        }
                    });
                } else {
                    callback(403, {'Error': 'Missing required token in header, or token is invalid'})
                                        ...
                                        _data.delete('checks', checkId, function (err) {
                                            ...
                                            if (checksDeleted == checksToDelete) {
                                                if (!deletionErrors) {
                                                    ...
                                                    callback(500, {'Error': 'Errors encountered while attempting to delete all of the user\'s checks may not have been deleted from the system successfully '})
                                                }
                                            }
                                        });
                                    });
